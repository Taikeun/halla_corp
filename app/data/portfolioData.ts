export const portfolioProjects = [
    {
        title: "e편한세상 영종국제도시 센텀베뉴",
        subtitle: "오렌지로비",
        details: {
            client: "DL이앤씨",
            builder: "DL이앤씨",
            product: "스틸커튼월 / STL 부자재 납품",
            location: "인천광역시 중구",
    ...
    },
    {
        ...
        subtitle: "중 스틸커튼월 공사",
        details: {
            client: "FRENCH EMBASSY OF SEOUL",
            builder: "㈜이안알앤씨",
            product: "스틸커튼월 / STL 부자재 납품",
            location: "서울특별시 서대문구",
    ...
    },
    {
        ...
        subtitle: "금속창호, 지붕건축물조립 공사",
        details: {
            client: "㈜포스코건설",
            builder: "㈜포스코건설",
            product: "스틸트러스 및 옥상조형물 / STL 부자재 납품",
            location: "경기도 의정부",
    ...
    {
        title: "제네시스 광주",
        subtitle: "스틸 커튼월 / STS,STL 부자재 납품",
        details: {
            client: "현대자동차㈜",
            builder: "현대엔지니어링㈜",
            product: "스틸 커튼월 / STS,STL 부자재 납품",
            location: "광주광역시",
    ...
    },
    {
        ...
        details: {
            client: "지에스건설㈜",
            builder: "㈜크리에이티브 디자인 스튜디오",
            product: "스틸커튼월 / STS,STL 부자재납품",
            location: "서울 강남",
